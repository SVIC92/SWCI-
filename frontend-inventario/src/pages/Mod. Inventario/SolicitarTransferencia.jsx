...
const SolicitarTransferencia = () => {
    ...
    const agregarAlCarrito = () => {
        ...
        // Obtener datos completos del producto para mostrar nombre/código en la tabla
        const productoInfo = productos.find(p => p.id_p === itemActual.productoId) || {};
    ...
    const enviarSolicitud = async () => {
        ...
        try {
            ...
            // Redirigir o limpiar
            navigate('/inventario/transferencias/gestion'); // O limpia el formulario
            ...
            <Paper elevation={3} sx={{ p: 4 }}>
                ...
                <Grid container spacing={2} alignItems="center" sx={{ mb: 2 }}>
                    <Grid item xs={12} md={6}>
                        ...
                        >
                            {productos.map((prod) => (
                                <MenuItem key={prod.id_p} value={prod.id_p}>
